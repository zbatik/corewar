...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/25 14:33:19 by emaune            #+#    #+#             */
/*   Updated: 2018/09/25 14:38:11 by emaune           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_sti_error_1(t_main *var, char **args)
{
	if (!args[1])
	{
		...
		ft_printf(2, lr, "Expected:\tsti [T_REG], [T_REG | T_DIR | T_IND], ");
		ft_printf(2, lr, "[T_REG | T_DIR].\nGot:\t\t\"%s\" - line #%d\n",
